...
Free MIT-licensed tools for spreadsheet text, Markdown tables, local file checks, form validation, table selection, calendar arithmetic, workday schedules and chart gaps. Choose a module for your application or try the browser playground. Each tool has its own setup; JavaScript modules do not require Python.
